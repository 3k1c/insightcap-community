...
export function SetupPage({ onComplete }: SetupPageProps) {
    ...
    async function handleWorkspaceNext() {
        ...
        try {
            ...
            if (authStatus.isSetup || authStatus.isMigrated) {
                setError(tr(
                    'auth.setup.workspace_existing',
                    'This folder already contains an InsightCAP knowledge base. Choose a new folder for first setup.'
                ));
    ...
    const stepTitle = {
        ...
        password: tr('auth.setup.password_title', 'Set Master Password'),
    ...
    const stepDescription = {
        ...
        password: tr('auth.setup.password_desc', 'This password protects your local data. InsightCAP does not store or upload your password.'),
    ...
    return (
        <div className="min-h-screen w-screen bg-[linear-gradient(135deg,#f8fafc_0%,#eef4ff_100%)] px-6 py-10 text-text-primary">
            <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-3xl items-center justify-center">
                <section className="w-full max-w-[620px] rounded-2xl border border-stroke-divider bg-white/95 p-9 shadow-[0_22px_60px_rgba(15,23,42,0.14)]">
                    ...
                    {step === 'welcome' && (
                        <div className="space-y-5">
                            <div className="rounded-xl border border-stroke-divider bg-surface-base p-4">
                                <div className="grid gap-3 sm:grid-cols-2">
                                    {[
                                        ...
                                        return (
                                            <div key={String(label)} className="flex items-center gap-2 text-fs-sm text-text-secondary">
                                                <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-accent-default/10 text-accent-default">
                            ...
                            <div className="flex items-center justify-between rounded-xl border border-stroke-divider bg-white px-4 py-3">
                                <label htmlFor="setup-language" className="text-fs-sm font-medium text-text-secondary">
                                ...
                                <select
                                    ...
                                    className="h-9 rounded-lg border border-stroke-divider bg-surface-base px-3 text-fs-sm text-text-primary focus:outline-none focus:ring-1 focus:ring-stroke-focus"
                                >
                            ...
                            <div className="rounded-xl border border-stroke-divider bg-surface-base p-4">
                                <div className="mb-3 text-fs-sm font-medium text-text-primary">
                                ...
                                <p className="mt-3 text-fs-xs text-text-tertiary">
                    ...
                    {step === 'recovery' && (
                        <div className="space-y-5">
                            ...
                            <label className="flex cursor-pointer items-center gap-2 rounded-lg border border-stroke-divider bg-white px-3 py-3">
                                <input
                                    type="checkbox"
...
function HotkeyRow({ label, value }: { label: string; value: string }) {
    return (
        <div className="flex items-center justify-between gap-3">
            ...
            <kbd className="rounded-md border border-stroke-divider bg-white px-2 py-1 font-mono text-fs-xs text-text-primary">
                {value}
            </kbd>
        </div>
    );
