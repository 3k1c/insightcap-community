...
export interface TranslationKeys {
    ...
    editor: {
        ...
        validation_empty_document: string;
        validation_untitled_document: string;
        validation_image_missing_alt: string;
        validation_large_inline_image: string;
        validation_empty_table: string;
        validation_empty_table_cell: string;
        validation_wide_table: string;
        validation_merged_table_cells: string;
        validation_empty_table_header: string;
        validation_invalid_link: string;
        ai_improve: string;
        ai_back: string;
