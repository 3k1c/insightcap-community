...
export function MemoryConfirmToast() {
    ...
    return (
        <div className="fixed bottom-20 right-4 z-50 w-80 rounded-xl border border-stroke-divider bg-surface-base shadow-flyout animate-in slide-in-from-bottom-4 duration-300">
            {/* Header */}
