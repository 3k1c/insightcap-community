...
export function PatternPromotionToast() {
    ...
    return (
        <div className="fixed bottom-4 left-4 z-50 w-96 rounded-xl border border-stroke-divider bg-surface-card shadow-flyout animate-in slide-in-from-bottom-4 duration-300">
            {/* Header */}
